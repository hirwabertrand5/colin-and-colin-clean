...
const titles: Record<PeopleCapacityView, { title: string; description: string }> = {
  ...
  capacity: { title: 'Capacity', description: 'Workload signals from assigned tasks and matters. Working capacity is not configured in the current HR model.' },
  ...
  'staff-cost': { title: 'Staff Cost', description: 'Salary, benefits and allocated staff-cost data are not configured in the current HR/finance model.' },
