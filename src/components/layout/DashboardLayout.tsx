  ...
  const managementNavigation: NavItem[] = [
    ...
    },
    {
      name: 'Task Management', href: '/tasks', icon: ListChecks, roles: managementRoles, submenu: [
        managementItem('All Tasks', '/tasks/all', ListChecks),
        managementItem('My Tasks', '/tasks/my', UserCheck),
        managementItem('Unassigned Tasks', '/tasks/unassigned', UserCog),
        managementItem('Due Today', '/tasks/due-today', CalendarIcon),
        managementItem('Due This Week', '/tasks/due-this-week', CalendarPlus),
        managementItem('Overdue Tasks', '/tasks/overdue', FileClock),
        managementItem('Awaiting Review', '/tasks/awaiting-review', ClipboardCheck),
        managementItem('Awaiting External Action', '/tasks/awaiting-external-action', HandCoins),
        managementItem('Completed Tasks', '/tasks/completed', CheckSquare),
        managementItem('Closed Tasks', '/tasks/closed', FolderTree),
        managementItem('Task Performance', '/tasks/performance', Activity),
      ],
    },
    {
    ...
    },
    {
      name: 'Billing & Finance', href: '/billing', icon: DollarSign, roles: managementRoles, submenu: [
        managementItem('Financial Dashboard', '/billing/finance/financial-dashboard', Landmark),
        managementItem('Billing & Invoicing', '/billing/finance/invoicing', ReceiptText),
        managementItem('Collections & Receivables', '/billing/finance/collections', HandCoins),
        managementItem('Profitability', '/billing/finance/profitability', ChartNoAxesCombined),
        managementItem('Cash & Cash Flow', '/billing/finance/cash-flow', Wallet),
        managementItem('Expenses & Procurement', '/billing/finance/expenses', ShoppingCart),
        managementItem('Firm Remuneration', '/billing/finance/remuneration', Coins),
      ],
    },
    {
