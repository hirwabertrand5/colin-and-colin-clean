...
export default function TaskManagementPage({ view }: { view: TaskManagementView }) {
  ...
  if (loading) return <div className="py-12 text-center text-gray-500">Loading tasks...</div>;
